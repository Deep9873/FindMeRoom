...
@api_router.post("/panel/auth/login", response_model=TokenResponse)
...
@api_router.get("/panel/users/{user_id}")
...
@api_router.post("/panel/users", response_model=User)
...
@api_router.put("/panel/users/{user_id}")
...
@api_router.delete("/panel/users/{user_id}")
...
@api_router.get("/panel/properties")
...
@api_router.put("/panel/properties/{property_id}")
...
@api_router.delete("/panel/properties/{property_id}")
...
@api_router.get("/panel/support/{message_id}")
...
@api_router.put("/panel/support/{message_id}")
...
@api_router.get("/panel/dashboard/stats")
...
@api_router.get("/panel/dashboard/recent-activity")
